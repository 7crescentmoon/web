...
<?php foreach ($result as $res) : ?>
    <div class="card">
      ...
      <div class="wrapper-left">
        ...
        <div class="location">
          <span class="logo"><svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 384 512">
              <style>
                svg {
                  fill: #000000
                }
    ...
    <div class="footer">
      ...
      <div class="footer-center">
        <div class="footer-about">
          ...
          <span class="f-about-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur repellat
            necessitatibus</span>
        </div>
        <hr>
        <div class="footer-socialmedia">
          ...
          <ul>
            ...
            <a href="">
              <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 448 512">
                  <style>
                    svg {
                      fill: #000000
                    }
            ...
            <a href="">
              <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 496 512">
                  <style>
                    svg {
                      fill: #000000
                    }
